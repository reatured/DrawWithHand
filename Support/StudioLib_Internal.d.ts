// Lens Studio Version: 4.25.0 (Internal)
// Snapchat Version: 11.87 (Internal)
...
interface LocationCloudStore extends ScriptObject {
    getValue(key: string, readOptions: CloudStorageReadOptions, onRetrieved: (collection: string, key: string, value: (mat4|mat3|mat2|vec4|vec2|vec3|boolean|quat|number|string)) => void, onError: (code: string, description: string) => void): void

    setValue(key: string, value: (mat4|mat3|mat2|vec4|vec2|vec3|boolean|quat|number|string), writeOptions: CloudStorageWriteOptions, onSaved: () => void, onError: (code: string, description: string) => void): void

    deleteValue(key: string, readOptions: CloudStorageReadOptions, onDeleted: () => void, onError: (code: string, description: string) => void): void

    listValues(listOptions: CloudStorageListOptions, onRetrieved: (collection: string, values: (mat4|mat3|mat2|vec4|vec2|vec3|boolean|quat|number|string)[][], cursor: string) => void, onError: (code: string, description: string) => void): void
